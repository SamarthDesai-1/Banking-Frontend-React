                    ...
                    <div className="listi">
                        <div className="containe-two col-md-8">
                            <div className="contain">
                                <div className="box">
                                   <NavLink to="../Fix_Deposit_form"> <h4 className='ms-3'>Open Fixed Deposit</h4></NavLink>
                                </div>
                                {/* <div className="box">
                                <NavLink to=""><h4 className='ms-3'>Open Recurring Deposit</h4></NavLink>
                                </div> */}
                                <div className="box">
                                <NavLink to="../View_rates"><h4 className='ms-3'>
                                        View All Rates</h4></NavLink>
                                </div>
                                <div className="box">
                                <NavLink to="../Deposit_status"><h4 className='ms-3'>View Fix/Recurring Deposit Status</h4></NavLink>
                                </div>
                            </div>
