              ...
              >
                ...
                >
                  ...
                  <div style={{ display: "grid", gridGap: "5px" }}>
                    ...
                    <p
                      style={{ fontSize: "0.875rem", margin: 0, color: "#666" }}
                    >
                      Customer ID : {!data ? "Waiting..." : data._id}
                    </p>
                  </div>
                  <div style={{ position: "absolute", right: "35px" }}>
                    <Tooltip title="Edit Profile" arrow>
                      <NavLink to="/Edit_Profile" style={{ color: "black" }}>
                        <EditIcon style={{ fontSize: "30px" }}></EditIcon>
                      </NavLink>
