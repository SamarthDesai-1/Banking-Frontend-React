      ...
      <form onSubmit={handleSubmit}>
        ...
        <div style={{ paddingRight: "20px" }} className="rounded-lg border bg-card text-card-foreground shadow-sm w-full max-w-4xl" data-v0-t="card">
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70" htmlFor="Photo">
                Photo
              </label>
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <input
                  type="date" id="DOB" name="DOB" onChange={handleInputChange}
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <input
                  type="text" id="PanCard" name="PanCard" value={formData.PanCard} onChange={handleInputChange} 
                  className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
