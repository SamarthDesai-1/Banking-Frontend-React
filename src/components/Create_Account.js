                    ...
                    <div className="p-6 space-y-6">
                        <div className="grid grid-cols-2 gap-6">
                            <div className="space-y-2">
                                ...
                                />
                                {errors && errors.FirstName && <p className='text-danger err'>{errors.FirstName.message}</p>}
                            </div>
                            <div className="space-y-2">
                                <label
                                    className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
                                ...
                                />
                                 {errors && errors.LastName && <p className='text-danger err'>{errors.LastName.message}</p>}
                            </div>
                        </div>
                        <div className="space-y-2">
                            <label
                            ...
                            <input {...register('Photo')} value={Photo} onChange={(e) => setPhoto(e.target.value)}
                                ...
                                type="file"
                            />
                             {errors && errors.Photo && <p className='text-danger err'>{errors.Photo.message}</p>}
                        </div>
                        <div className="grid grid-cols-2 gap-6">
                            <div className="space-y-2">
                                <label
                                ...
                                {...register('DOB')} value={DOB} onChange={(e) => setDOB(e.target.value)}
                                    ...
                                    type="date"
                                />
                                 {errors && errors.DOB && <p className='text-danger err'>{errors.DOB.message}</p>}
                            </div>
                            <div className="space-y-2">
                                <label
                                    className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
                                ...
                                {errors && errors.AccountType && <p className='text-danger err'>{errors.AccountType.message}</p>}
                            </div>
                        </div>
                        <div className="grid grid-cols-2 gap-6">
                            <div className="space-y-2">
                                ...
                                <input {...register('Mobile')} value={Mobile} onChange={(e) => setMobile(e.target.value)}
                                    ...
                                    type="tel"
                                />
                                 {errors && errors.Mobile && <p className='text-danger err'>{errors.Mobile.message}</p>}
                            </div>
                            <div className="space-y-2">
                                <label
                                    className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
                                ...
                                />
                                {errors && errors.PanCard && <p className='text-danger err'>{errors.PanCard.message}</p>}
                            </div>
                        </div>
                        <div className="grid grid-cols-2 gap-6">
                            <div className="space-y-2">
                                ...
                                />
                                 {errors && errors.AadharCard && <p className='text-danger err'>{errors.AadharCard.message}</p>}
                            </div>
                            <div className="space-y-2">
                                <label
                                    className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
                                ...
                                />
                                 {errors && errors.Nominee && <p className='text-danger err'>{errors.Nominee.message}</p>}
                            </div>
                        </div>
                        <div className="space-y-2">
                            <label
                            ...
                            />
                            {errors && errors.NomineeAadharCard && <p className='text-danger err'>{errors.NomineeAadharCard.message}</p>}
                        </div>
                        <div className="space-y-2">
                            <label
                                className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
                            ...
                            />
                              {errors && errors.Address && <p className='text-danger err'>{errors.Address.message}</p>}
                        </div>
                        <div className="space-y-2">
                            <label
                                className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
                            ...
                            />
                            {errors && errors.MonthlyIncome && <p className='text-danger err'>{errors.MonthlyIncome.message}</p>}
                        </div>
                    </div>
